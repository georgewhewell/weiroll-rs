...
pub mod executor_token {
    ...
    pub static EXECUTORTOKEN_BYTECODE: ::ethers::core::types::Bytes =
    ...
    pub static EXECUTORTOKEN_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes =
    ...
    impl<M: ::ethers::providers::Middleware> ExecutorToken<M> {
        ...
        pub fn events(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, ExecutorTokenEvents>
        {
            self.0
