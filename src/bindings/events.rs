...
pub mod events {
    ...
    pub static EVENTS_BYTECODE: ethers::contract::Lazy<ethers::core::types::Bytes> =
        ethers::contract::Lazy::new(|| {
            "" . parse () . expect ("invalid bytecode")
        });
    ...
    impl<M: ethers::providers::Middleware> Events<M> {
        ...
        pub fn new<T: Into<ethers::core::types::Address>>(
            ...
            ethers::contract::Contract::new(address.into(), EVENTS_ABI.clone(), client).into()
        }
        ...
        #[doc = "Calls the contract's `logAddress` (0x5f91b0af) function"]
        pub fn log_address(
            &self,
        ...
        #[doc = "Calls the contract's `logBytes` (0xe17bf956) function"]
        pub fn log_bytes(
            &self,
        ...
        #[doc = "Calls the contract's `logBytes32` (0x2d21d6f7) function"]
        pub fn log_bytes_32(
            &self,
            message: [u8; 32],
        ) -> ethers::contract::builders::ContractCall<M, ()> {
        ...
        #[doc = "Calls the contract's `logString` (0x0bb563d6) function"]
        pub fn log_string(
            &self,
            message: String,
        ) -> ethers::contract::builders::ContractCall<M, ()> {
        ...
        #[doc = "Calls the contract's `logUint` (0x9905b744) function"]
        pub fn log_uint(
            &self,
        ...
        #[doc = "Calls the contract's `logUintPayable` (0x360db92d) function"]
        ...
        #[doc = "Gets the contract's `LogAddress` event"]
        pub fn log_address_filter(&self) -> ethers::contract::builders::Event<M, LogAddressFilter> {
            self.0.event()
        }
        #[doc = "Gets the contract's `LogBytes` event"]
        pub fn log_bytes_filter(&self) -> ethers::contract::builders::Event<M, LogBytesFilter> {
            self.0.event()
        }
        #[doc = "Gets the contract's `LogBytes32` event"]
        pub fn log_bytes_32_filter(
            &self,
        ) -> ethers::contract::builders::Event<M, LogBytes32Filter> {
            self.0.event()
        }
        #[doc = "Gets the contract's `LogString` event"]
        pub fn log_string_filter(&self) -> ethers::contract::builders::Event<M, LogStringFilter> {
            self.0.event()
        }
        #[doc = "Gets the contract's `LogUint` event"]
    ...
    #[doc = "Container type for all input parameters for the `logAddress` function with signature `logAddress(address)` and selector `[95, 145, 176, 175]`"]
    #[derive(
        Clone,
        Debug,
        Eq,
    ...
    #[doc = "Container type for all input parameters for the `logBytes` function with signature `logBytes(bytes)` and selector `[225, 123, 249, 86]`"]
    #[derive(
        Clone,
        Debug,
        Eq,
    ...
    #[doc = "Container type for all input parameters for the `logBytes32` function with signature `logBytes32(bytes32)` and selector `[45, 33, 214, 247]`"]
    #[derive(
        Clone,
        Debug,
        Eq,
    ...
    #[doc = "Container type for all input parameters for the `logString` function with signature `logString(string)` and selector `[11, 181, 99, 214]`"]
    #[derive(
        Clone,
        Debug,
        Eq,
    ...
    #[doc = "Container type for all input parameters for the `logUint` function with signature `logUint(uint256)` and selector `[153, 5, 183, 68]`"]
    #[derive(
        Clone,
        Debug,
        Eq,
    ...
    #[doc = "Container type for all input parameters for the `logUintPayable` function with signature `logUintPayable(uint256)` and selector `[54, 13, 185, 45]`"]
    #[derive(
        Clone,
        Debug,
        Eq,
    ...
    impl ethers::core::abi::AbiDecode for EventsCalls {
        fn decode(
            ...
            if let Ok(decoded) =
                <LogAddressCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(EventsCalls::LogAddress(decoded));
            }
            if let Ok(decoded) =
                <LogBytesCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(EventsCalls::LogBytes(decoded));
            }
            if let Ok(decoded) =
                <LogBytes32Call as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(EventsCalls::LogBytes32(decoded));
            }
            if let Ok(decoded) =
                <LogStringCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(EventsCalls::LogString(decoded));
            }
            if let Ok(decoded) =
                <LogUintCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(EventsCalls::LogUint(decoded));
            }
            if let Ok(decoded) =
                <LogUintPayableCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
